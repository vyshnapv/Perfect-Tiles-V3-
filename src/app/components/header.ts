...
@Component({
  ...
  template: `
    <header class="fixed top-0 left-0 w-full z-50 py-3 bg-slate-900/90 backdrop-blur-md shadow-lg border-b border-white/5 transition-all duration-300 relative">
